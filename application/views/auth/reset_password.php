...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php }?>
    <form action="<?php echo base_url('auth/reset_password').'/'.$code;?>" method="post" id="form-forgot-password">
      ...
      <div class="row"> 
		...
		<?php echo form_hidden($csrf);?>
		 <div class="col-xs-6">
          <button type="submit" class="btn btn-primary btn-block btn-flat" id="btn-login">Submit</button>
        </div>
        <div class="col-xs-6">
          <a class="btn btn-default btn-block btn-flat" href="<?php echo base_url()?>">Login</a>
        </div>
