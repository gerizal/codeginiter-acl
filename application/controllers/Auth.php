	...
	public function forgot_password()
	{
		...
		else
		{
			...
			if($this->input->post()){
				...
				if($this->form_validation->run()===TRUE){
					if($this->user_model->getOneBy(['users.email'=>$this->input->post('email')])){
						$detail = $this->user_model->getOneBy(['users.email'=>$this->input->post('email')]);
						...
						$updateddetail = $this->user_model->getOneBy(['users.email'=>$this->input->post('email')]);
						$link = 'auth/reset_password/'.$updateddetail->forgotten_password_code;
						if(forgot_password($detail->email,$detail->first_name.' '.$detail->last_name,$link,$updateddetail->forgotten_password_code)){
							$this->session->set_flashdata('message','Berhasil Mengirim Email');
						}else{
